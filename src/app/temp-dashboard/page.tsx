...
const routes = [
  ...
  { group: "Administración (Dashboard)", items: [
    { name: "Panel Admin", path: "/admin", description: "Dashboard principal de administración, Ingresa con: Probanding@prueba.com y pwd: 123456789" },
  ...
  { group: "Conductor", items: [
    { name: "Dashboard Conductor", path: "/driver/dashboard", description: "Vista del conductor" },
    { name: "Estado de Servicio", path: "/driver/status", description: "Estado actual y turno" },
  ]},
  { group: "Usuario", items: [
    { name: "Dashboard Usuario", path: "/user/dashboard", description: "Panel personal" },
    { name: "Asistente AI (Chat)", path: "/user/chat", description: "Consulta de rutas inteligentes" },
    ...
    <main className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mt-20 p-8 bg-blue-50 rounded-3xl border border-blue-100 text-center">
          <p className="text-sm font-bold text-blue-700 mb-2 uppercase tracking-wide">Nota del Desarrollador</p>
          <p className="text-slate-600 text-sm leading-relaxed max-w-xl mx-auto">
            Todo esto es lo que se debe trabajar en el proyecto, un mvp creado para hacer el lanzamiento en vercel y test de la aplicación, preferiblemente esto se va a elminar y es algo momentaneo para centralizarnos en cada trabajo
          </p>
        </div>
      </div>
    </main>
